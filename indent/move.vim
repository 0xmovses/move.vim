...
function! s:is_string_comment(lnum, col)
    if has('syntax_items')
        for id in synstack(a:lnum, a:col)
            ...
            if synname ==# "moveString" || synname =~# "^moveComment"
                return 1
            endif
        endfor
    else
